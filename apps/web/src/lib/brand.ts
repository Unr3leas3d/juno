 ...
 * Juno brand. Marketing lives in platform/builder-web (`/` + `/builder`).
 */

const env = import.meta.env as Record<string, string | undefined>;

/** Set → this build is a deployed agent's dashboard, not the Juno demo. */
...
export const BRAND_NAME: string = AGENT_NAME ?? "Juno";
